...
public class QueryParamXMLToString {
    ...
    public QueryParamXMLToString(String seqStr, String from_instance, String to_instance, String deviceID){
    ...
    public String queryParam(){
        ...
        tsccmd.addElement("ObjName").addText("NBDeviceParam");
