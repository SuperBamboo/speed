...
public class SetParamXMLToString {
    ...
    public SetParamXMLToString(String seqStr, String from_instance, String to_instance, String deviceID,String parameter){
    ...
    public String queryParam(){
        ...
        Element tsccmd = Operation.addElement("NBDeviceParamSet");
        tsccmd.addElement("DeviceID").addText(deviceID);
        tsccmd.addElement("ParamLen").addText("1024");
        tsccmd.addElement("Parameter").addText(parameter);
