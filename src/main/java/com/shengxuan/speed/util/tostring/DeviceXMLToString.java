...
public class DeviceXMLToString {
    private String seqStr;
    private String from_Instance;
    private String to_Instance;
    private String deviceId;

    public DeviceXMLToString(String seqStr,String from_Instance,String to_Instance,String DeviceID){
        this.seqStr = seqStr;
    ...
    public String sysInfoXMLToString(){
        //生成心跳xml文件
        ...
        TSCCmd.addElement("ObjName").addText("DeviceParam");
