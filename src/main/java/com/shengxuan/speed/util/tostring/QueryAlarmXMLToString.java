...
public class QueryAlarmXMLToString {
    ...
    public QueryAlarmXMLToString(String seqStr,String from_Instance,String to_Instance,String deviceID,String dateBegin){
        this.seqStr = seqStr;
    ...
    public String queryAlarm(){
        ...
        tsccmd.addElement("StartTime").addText(dateBegin);
