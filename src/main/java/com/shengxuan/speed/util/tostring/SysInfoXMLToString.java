...
/**
 * 请求获取系统对象(SysInfo)String
 */
public class SysInfoXMLToString {

    private String seqStr;
    private String from_Instance;
    private String to_Instance;

    public SysInfoXMLToString(String seqStr,String from_Instance,String to_Instance){
        this.seqStr = seqStr;
