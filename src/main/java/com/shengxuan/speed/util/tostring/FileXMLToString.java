...
public class FileXMLToString {
    ...
    public FileXMLToString(String seqStr,String from_instance,String to_instance,String fileName){
    ...
    public String FileXMLToString(){
        ...
        tsccmd.addElement("ObjName").addText("FileInfo");
        tsccmd.addElement("FileName").addText(fileName);
