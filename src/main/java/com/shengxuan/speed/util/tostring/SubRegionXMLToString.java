 ...
 * 请求获取子区对象String
 */
public class SubRegionXMLToString {

    private String seqStr;
    private String regionID;
    private String form_instance;
    private String to_instance;

    public SubRegionXMLToString(String seqStr,String regionID,String form_instance,String to_instance){
        this.seqStr = seqStr;
    ...
    public String getSubRegionXMLToString(){
        //生成心跳xml文件
        ...
        Element instance = address.addElement("Instance").addText(form_instance);
        ...
        TSCCmd.addElement("ObjName").addText("SubRegionParam");
        TSCCmd.addElement("RegionID").addText(regionID);
